...
export default function AddNewInterviewPage() {
  ...
  const handleSave = async (e) => {
    ...
    await add({
      loanInfo: {
        quest_1: inputs.loan_answer_1,
        quest_2: inputs.loan_answer_2,
        quest_3: inputs.loan_answer_3,
      },
      clientInfo: client,
      personalDetail: {
        quest_1: inputs.personal_answer_1,
        quest_2: inputs.personal_answer_2,
        quest_3: inputs.personal_answer_3,
      },
      householdDetail: {
        quest_1: inputs.household_answer_1,
        quest_2: inputs.household_answer_2,
        quest_3: inputs.household_answer_3,
      },
      businessProfile: {
        quest_1: inputs.business_answer_1,
        quest_2: inputs.business_answer_2,
        quest_3: inputs.business_answer_3,
      },
